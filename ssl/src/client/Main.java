...
public class Main
{
    ...
    public final static int TLS_SERVER_PORT = 23113;
    ...
    public static void main(String[] args) throws Exception
    {
         ...
         */
        ConnectToServer sslConnectToServer = new ConnectToServer(TLS_SERVER_ADDRESS, TLS_SERVER_PORT);
        /*
